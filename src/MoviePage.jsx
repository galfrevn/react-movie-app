...
function MoviePage() {
  ...
  const { title, overview, genres, runtime, poster_path, vote_average, release_date, backdrop_path } =
    movieInfo;
  ...
  return (
    ...
    <a href="/" className="absolute top-10 left-10" >Volver</a>
        ...
        <div class="bg-white shadow-lg mb-12 border-gray-100 	 border sm:rounded-3xl p-8 flex space-x-8">
          ...
          <div class="flex flex-col w-1/2 space-y-4">
            <div class="flex justify-between items-start">
              ...
              <div class="bg-yellow-400 font-bold rounded-xl p-2">{vote_average} </div>
            </div>
            <div>
            ...
            <div class="flex text-2xl font-bold text-a">{convertMinsToHrsMins(runtime)} </div>
          </div>
        </div>
      </div>
    </div>
